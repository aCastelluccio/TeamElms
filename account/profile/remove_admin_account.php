...
$sth = $dbh->prepare("SELECT u.email, ui.first_name, ui.last_name, ui.isAdmin FROM user_info ui JOIN users u ON ui.uid = u.id WHERE ui.approved = 1 AND ui.isAdmin = 1 ");
$sth->execute();
...
<head>
  ...
  <title>Admin Page - Set an Account to Admin Status</title>
  <!-- Bootstrap core CSS-->
    ...
    <div class="card mb-3">
        ...
        <div class="card-body">
          <div class="table-responsive">
            <form action="revoke_admin.php" method="post">
