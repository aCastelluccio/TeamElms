...
$sth = $dbh->prepare("SELECT u.email, ui.first_name, ui.last_name, ui.isAdmin FROM user_info ui JOIN users u ON ui.uid = u.id WHERE ui.approved = 1 AND ui.isAdmin = 0 ");
$sth->execute();
